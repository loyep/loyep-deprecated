...
@section('content')
    <div class="card card-round card-shadowed px-50 py-30 w-400px mb-0" style="max-width: 100%;">
        ...
        <form class="form-type-material" method="post" action="{{ route('planet.password.request') }}">
            @csrf
            ...
            <br>
            <button class="btn btn-bold btn-block btn-info" type="submit">{{ __('Reset Password') }}</button>
        </form>
    </div>
@endSection
