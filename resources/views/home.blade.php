        ...
        <div class="container text-center">
            <div class="row h-100">
                <div class="col-lg-8 mx-auto align-self-center">
                    <h1 class="display-4 my-6"><strong>{{ config('app.name') }}</strong></h1>
                    <p class="lead-3">The <b>most popular</b> HTML, CSS, and JS <b>framework</b> in the world for
                        building
        ...
        <section class="section">
            <div class="container">
                <header class="section-header">
                    ...
                    <hr>
                    <p class="lead">Bootstrap makes front-end web development faster and easier. It's made for folks of
                        all
                ...
                <div class="row gap-y text-center">
                    ...
                    <div class="col-md-6 col-xl-4 feature-1">
                        ...
                        <p>Bootstrap easily and efficiently scales your websites and applications with a single code
                            base,
        ...
        <section class="section">
            <div class="container">
                <header class="section-header">
                    ...
                    <hr>
                    <p class="lead">Over a dozen reusable components built to provide iconography, dropdowns, input
                        groups,
        ...
        <section class="section bg-gray pb-0 overflow-hidden">
            <div class="container">
                <header class="section-header">
                    ...
                    <hr>
                    <p class="lead">Millions of amazing sites across the web are being built with Bootstrap. Get started
                        on
                ...
                <div class="row gap-y text-center">
                    ...
                    <div class="col-md-4 d-flex flex-column">
                        ...
                        <div class="px-5 mt-auto">
                            <img class="shadow-4 opacity-80" src="{{ Loyep::asset('img/preview/header-color.jpg') }}"
                                 alt="..."
                    ...
                    <div class="col-md-4 d-flex flex-column">
                        ...
                        <div class="px-5 mt-auto">
                            <img class="shadow-4 opacity-80" src="{{ Loyep::asset('img/preview/header-typing.jpg') }}"
                                 alt="..."
